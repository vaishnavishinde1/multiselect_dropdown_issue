angular.module('cpp.controllers').
    controller('ServiceClassCtrl', ['$http', 'Page', '$state', 'UpdateServiceClass', '$uibModal', '$scope', '$rootScope', 'TrendStatus', '$location', '$timeout','ServiceClass',
        function ($http, Page, $state, UpdateServiceClass, $uibModal, $scope, $rootScope, TrendStatus, $location, $timeout, ServiceClass) {
            var okToExit = true;
            ...
            var url = serviceBasePath + 'Response/ServiceClass/';
